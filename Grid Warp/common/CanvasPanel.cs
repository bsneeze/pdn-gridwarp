using PaintDotNet;
using pyrochild.effects.gridwarp;
using System;
...
namespace pyrochild.effects.common
{
    public partial class CanvasPanel : UserControl
    {
        ...
        void canvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (BrushVisible && (panelhasmouse || canvashasmouse))
            {
        ...
        private void OnCanvasPaint(PaintEventArgs e)
        {
            if (CanvasPaint != null)
                CanvasPaint(this, e);
        }
        ...
        [DefaultValue(true)]
        public bool BrushVisible { get; set; }
    }
